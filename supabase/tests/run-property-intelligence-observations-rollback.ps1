...
Run (Join-Path $PSScriptRoot 'property-intelligence-observations-rollback.integration.sql')
Write-Host 'Property intelligence observation rollback test passed.'
