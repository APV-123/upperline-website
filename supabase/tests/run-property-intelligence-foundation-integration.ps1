...
Run (Join-Path $PSScriptRoot 'property-intelligence-foundation.integration.sql')
Write-Host 'Property intelligence foundation integration tests passed.'
