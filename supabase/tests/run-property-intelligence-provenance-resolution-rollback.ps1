...
Run (Join-Path $PSScriptRoot 'property-intelligence-provenance-resolution-rollback.integration.sql')
Write-Host 'Property intelligence provenance-resolution rollback tests passed.'
